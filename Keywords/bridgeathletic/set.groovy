...
public class set {
	...
	@Keyword
	def getSetInfoInCalendar (int blockIndex, int exerciseIndex, int setIndex){

		String setText = '//md-dialog[@aria-label = "Workout Dialog"]//div[contains(@ng-repeat, "block in workout.data")]['+ blockIndex +']/div[@class="block-exercise ng-scope"]['+ exerciseIndex +']/div[@ng-repeat="blockSet in exercise.orderSets track by $index"]['+ setIndex +']'
