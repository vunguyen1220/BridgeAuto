...
RunConfiguration.setExecutionSettingFile('C:\\Users\\VuNA\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Doing\\Assigned Program -- Edits\\Clone Phase, Move Phase\\20190108_155547\\execution.properties')
...
not_run: WebUI.click(findTestObject('Org Home Page/span_LIBRARY'))

not_run: WebUI.callTestCase(findTestCase('Done/Commons/Waiting'), [:])

not_run: WebUI.callTestCase(findTestCase('Done/Commons/Filter Programs'), [('var_byType') : ['Assigned']])
