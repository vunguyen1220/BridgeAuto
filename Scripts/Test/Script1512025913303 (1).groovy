...
test.addProperty('xpath', ConditionType.EQUALS, 'id("exercise-content")//div[@class="single-row ng-scope"][1]//div[contains(@class,"single-value relative ng-scope")][1]/duration-input[@aria-hidden="false"]/input', true)



println WebUI.getAttribute(test, 'value')
